...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySide2Linux/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySide2Linux.packageEnvLib    @brief [ MODULE ] - Package environment module.
