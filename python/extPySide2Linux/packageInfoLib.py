...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @package extPySide2Linux                           @brief [ PACKAGE   ] - PySide2 (Python 3) for Linux OS.
## @dir     extPySide2Linux/python                    @brief [ DIRECTORY ] - Python path.
## @dir     extPySide2Linux/python/extPySide2Linux    @brief [ DIRECTORY ] - Python package.
## @file    extPySide2Linux/packageInfoLib.py         @brief [ FILE      ] - Package info module.
## @package extPySide2Linux.packageInfoLib            @brief [ MODULE    ] - Package info module.
...
NAME                = 'extPySide2Linux'

## [ str ] - Version of the package.
VERSION             = '5.15.2'

## [ str ] - Description about the package.
DESCRIPTION         = 'PySide2 (Python 3) for Linux OS.'
...
PYTHON_PACKAGES     = ['extPySide2Linux']